return Def.ActorFrame {
    ...
    LoadActor(THEME:GetPathG("", "failed bg.png"))..{ --BG - left half (we render this in two halves so we can get a mirrored gradient across the whole background)
    ...
    LoadActor(THEME:GetPathG("", "failed bg.png"))..{ --BG - right half
	...
	LoadActor(THEME:GetPathG("", "failed text-new.png"))..{ --Text
