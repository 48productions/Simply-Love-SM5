...
-- nothing handled by this file applies to or should appear in Casual/Demonstration mode
if SL.Global.GameMode == "Casual" or GAMESTATE:IsDemonstration() then return end
